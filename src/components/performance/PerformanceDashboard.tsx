...
export function PerformanceDashboard() {
  ...
  // Calculate message statistics using keyword detection
  // Note: This is a client-side approximation. The full AI analysis uses rules from the bot's system prompt
